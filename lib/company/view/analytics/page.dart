import 'package:app/company/controller/analytics_controller.dart';
import 'package:app/company/view/analytics/dialogs/post_detail.dart';
import 'package:app/company/view/analytics/dialogs/user_detail.dart';
...
class _MyAnalyticsPageState extends State<MyAnalyticsPage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 4,
      child: LayoutBuilder(
        builder: (buildContext, constraints) => TabBarView(
