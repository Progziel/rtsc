...
class _PreviewSection extends StatelessWidget {
  const _PreviewSection(this.controller, {this.scrollable = false});
                          ...
                          IconButton(
                            onPressed: () {
                              ...
                              if (index == 0) {
                                ...
                                controller.pickedAudio.value = null;
                              } else if (index == 3) {
                                controller.pickedDocument.value = null;
                              }
                            },
