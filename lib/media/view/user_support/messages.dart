...
class _MyMessagesScreen extends StatelessWidget {
  _MyMessagesScreen(this.currentUser, this.chat);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: model.senderId == currentUser.id
                ...
                borderRadius: BorderRadius.only(
                    topLeft: model.senderId == currentUser.id
                        ? const Radius.circular(8.0)
                        : Radius.zero,
                    topRight: model.senderId != currentUser.id
                        ? const Radius.circular(8.0)
                        : Radius.zero,
            ...
            child: ListTile(
              dense: true,
              title: Text(
                model.senderId == currentUser.id ? 'Me' : 'User Support',
                textAlign: model.senderId == currentUser.id
                    ? TextAlign.right
                    : TextAlign.left,
